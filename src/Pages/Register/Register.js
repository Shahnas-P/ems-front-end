...
function Register() {
  ...
  // option tag value similar to html select tag
  const option = [
  ...
  return (
    <div className="container mt-2">
      ...
      <Form.Group className="mb-3 col-lg-6" controlId="formBasicpic">
        ...
        <Form.Control type="file" name='user__profile'  />
        
      </Form.Group>
      <Form.Group className="mb-3 col-lg-6" controlId="formBasicllocation">
